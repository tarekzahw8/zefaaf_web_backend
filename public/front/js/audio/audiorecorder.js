(function($){
	...
	$.audioRecorder = function(options){
		...
		var settings = $.extend({
			bufferLen:4096,
			workerSrc:{
				wav:'../../public/front/js/audio/audiorecorder_worker_wav.js',
				mp3:'../../public/front/js/audio/audiorecorder_worker_mp3.js'
			},
			getFileName:null,
			onaccept:function(){},
			onerror:function(){},
...
// 			});
			...
			// if (navigator.getUserMedia) { // if navigator.mediaDevices exists, use it
			// 	navigator.getUserMedia({
			// 		audio:true
			// 	}, gotStream, function(e){
			// 		settings.onerror(e);
