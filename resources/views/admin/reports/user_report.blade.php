...
@endif
    <form method="get" action="{{url('admin/UsersReport')}}" target="_blank">
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th style="color: red !important;"><b>العمر </b></th>
                                    <th style="color: red !important;"><b>الباقة </b></th>
                                    <th style="color: red !important;"><b>الدولة </b></th>
                                    <th style="color: red !important;"><b>المدينة </b></th>
                                    <th style="color: red !important;"><b>اخر ظهور </b></th>
                                </tr>
                            </thead>
                            <tbody>
                                @include("admin.$view.loop_users")
                        </tbody>
                    </table>
                </div>
                </div>
