        ...
        <div class="form-group m-form__group row ">
            ...
            <div class="col-4">
                <select name="field" class="form-control m-input">
                    <option value="nameAr">المدينة</option>
                </select>
            </div>
            ...
            <div class="col-4">
                ...
                <input type="hidden" name="country_id" value="{{ (isset(request()->country_id))? request()->country_id:'' }}">
                <input type="hidden" name="country_name" value=" {{ (isset(request()->country_name))? request()->country_name:'' }} ">
            </div>
            <div class="col-2">
            ...
            <div class="m-portlet__head">
                ...
                <div class="m-portlet__head-wrapper">
                    ...
                    <div class="m-portlet__head-tools">
                        ...
                        <a href="{{url('/admin/'.$route.'/create')}}?country_id={{ (isset(request()->country_id))? request()->country_id:'' }}" class="btn btn-brand m-btn m-btn--icon m-btn--wide m-btn--md m--margin-right-10">
                            <span>
                ...
                <div class="m-section">
                    <div class="m-section__content">
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    <th><b  style="color: red"> الدولة</b></th>
                                    <th><b  style="color: red">المدينة</b></th>
                                    <th><b  style="color: red">الحالة </b></th>
