...
$url = "";
if($user_name && $userId){
    $url = "?userId=$userId&user_name=$user_name";
}
@endphp
...
<br>
@if(isset($query ) or isset($message) or isset(request()->q))
<div>
            ...
            <div class="m-portlet__head">
                ...
                <div class="m-portlet__head-wrapper">
                    ...
                    <div class="m-portlet__head-tools">
                        ...
                        @if ($url)
                            <a href="{{url('/admin/'.$route.'/create')}}{{ $url }}" class="btn btn-brand m-btn m-btn--icon m-btn--wide m-btn--md m--margin-right-10">
                                <span>
						...
						<a href="{{url('/admin/'.$route.'/create')}}?message=all" class="btn btn-brand m-btn m-btn--icon m-btn--wide m-btn--md m--margin-right-10">
                                <span>
                                    <i class="la la-plus"></i>
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th><b>عنوان الرسالة</b></th>
                                    <th><b>حالة الرسالة </b></th>
                                    <th><b>التاريخ </b></th>
                                    <th>
                                        <b>
                                        {{ __('admin.control') }}
                                        <br />
                                        <a type="button" 
                                        href="{{url('/admin/'.$OtherRoute)}}/hideAll" 
                                        class="m-btn m-btn m-btn--square btn btn-danger" id="hideAll">
                                        اخفاء الكل
                                        </a>
                                        <a type="button" 
                                        href="{{url('/admin/'.$OtherRoute)}}/showAll" 
                                        class="m-btn m-btn m-btn--square btn btn-success" id="showAll">
                                        اظهار الكل
                                        </a>
                                    </b></th>
                                </tr>
...
{ 
    e.preventDefault();
    swal({   
            title: 'هل أنت متأكد من اخفاء الكل ؟',
...
{ 
    e.preventDefault();
    swal({   
            title: 'هل أنت متأكد من اظهار الكل ؟',
		  confirmButtonText:  'نعم',
		  cancelButtonText:  'لا',
		  showCancelButton: true,
		  showCloseButton: true,
...
$('._hide_message').on('click', function(e) 
{ 
    e.preventDefault();
    swal({   
            title: 'هل أنت متأكد من اخفاء هذه الرسالة ؟',
		    confirmButtonText:  'نعم',
		    cancelButtonText:  'لا',
		    showCancelButton: true,
		    showCloseButton: true,
