...
<div class="m-portlet">
        ...
        <div class="m-portlet__head-caption">
            <div class="m-portlet__head-name">
                ...
                <h3 class="m-portlet__head-text">
                    {{ ($row->types) ? $row->types->title : $row->name }}
                </h3>
            </div>
        </div>
    </div>
    ...
    <form class="m-form" action="#" method="post" enctype="multipart/form-data">
        ...
        <div class="m-portlet__body">
            ...
            <div class="form-group m-form__group row {{ $errors->has('message') ? 'has-danger' : ''}}">
                <label for="message" class="col-1 col-form-label"> الرد  </label>
                <div class="col-9">
                    <textarea class="form-control m-input" disabled="">{{ $row->admin_reply }}</textarea>
                </div>
            </div>
