@extends('admin.layouts.index_layout',['title' => __('admin.profile') ])
...
<div class="m-portlet">
    ...
    <!--begin::Form-->
    <form class="m-form" action="{{url('admin/profile/edit')}}" method="post" >
            ...
            <div class="form-group m-form__group row {{ $errors->has('email') ? 'has-danger' : ''}}">
                ...
                <div class="col-9">
                    <input type="text" class="form-control m-input"
                            placeholder="{{ __('admin.email') }}" name="email" value="{{ $admin['email'] }}">
