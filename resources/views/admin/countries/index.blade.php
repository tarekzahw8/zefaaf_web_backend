        ...
        <div class="form-group m-form__group row ">
            ...
            <div class="col-4">
                <select name="field" class="form-control m-input">
                    <option value="nameAr">اسم الدولة</option>
                    <option name="phoneCode">الكود</option>
                </select>
            </div>
                ...
                <div class="m-section">
                    <div class="m-section__content">
                        ...
                        <table class="table table-bordered" >
                            <thead>
                                <tr>
                                    <th><b  style="color: red">اسم الدولة</b></th>
                                    <th><b  style="color: red">الكود</b></th>
                                    <th><b  style="color: red">الحالة </b></th>
                                    <th><b  style="color: red">المدن </b></th>
...
<br>
@if(isset(request()->q ) or isset($message))
<div>
