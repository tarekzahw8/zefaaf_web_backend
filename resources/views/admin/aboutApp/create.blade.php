...
<div class="m-portlet">
        ...
        <div class="m-portlet__head-caption">
            <div class="m-portlet__head-name">
                ...
                <h3 class="m-portlet__head-text">
                   {{ __('admin.add') }} | {{ __('admin.aboutApp') }}
                </h3>
            </div>
        </div>
    </div>
    ...
    <!--begin::Form-->
    <form class="m-form" action="{{url('admin/aboutApp')}}" method="post" enctype="multipart/form-data">
        ...
        @endif
            ...
            <div class="form-group m-form__group row {{ $errors->has('body') ? 'has-danger' : ''}}">
                ...
                <div class="col-9">
                    <textarea class="form-control m-input" placeholder="{{ __('admin.body') }}" name="body" ></textarea>
            ...
            <div class="form-group m-form__group row {{ $errors->has('body_ar') ? 'has-danger' : ''}}">
                ...
                <div class="col-9">
                    <textarea class="form-control m-input" placeholder="{{ __('admin.body_ar') }}" name="body_ar" ></textarea>
            ...
            <div class="form-group m-form__group row {{ $errors->has('fb_link') ? 'has-danger' : ''}}">
                ...
                <div class="col-9">
                    <textarea class="form-control m-input" placeholder="{{ __('admin.fb_link') }}" name="fb_link" ></textarea>
            ...
            <div class="form-group m-form__group row {{ $errors->has('twitter_link') ? 'has-danger' : ''}}">
                ...
                <div class="col-9">
                    <textarea class="form-control m-input" placeholder="{{ __('admin.twitter_link') }}" name="desc_ar" ></textarea>
            ...
            <div class="form-group m-form__group row {{ $errors->has('google_link') ? 'has-danger' : ''}}">
                ...
                <div class="col-9">
                    <textarea class="form-control m-input" placeholder="{{ __('admin.google_link') }}" name="google_link" ></textarea>
            ...
            <div class="form-group m-form__group row {{ $errors->has('insta_link') ? 'has-danger' : ''}}">
                ...
                <div class="col-9">
                    <textarea class="form-control m-input" placeholder="{{ __('admin.insta_link') }}" name="insta_link" ></textarea>
            ...
            <div class="form-group m-form__group row {{ $errors->has('snap_link') ? 'has-danger' : ''}}">
                ...
                <div class="col-9">
                    <textarea class="form-control m-input" placeholder="{{ __('admin.snap_link') }}" name="snap_link" ></textarea>
            ...
            <div class="form-group m-form__group row {{ $errors->has('privacy_title') ? 'has-danger' : ''}}">
                ...
                <div class="col-9">
                    <textarea class="form-control m-input" placeholder="{{ __('admin.privacy_title') }}" name="privacy_title" ></textarea>
            ...
            <div class="form-group m-form__group row {{ $errors->has('privacy_title_ar') ? 'has-danger' : ''}}">
                ...
                <div class="col-9">
                    <textarea class="form-control m-input" placeholder="{{ __('admin.privacy_title_ar') }}" name="privacy_title_ar" ></textarea>
            ...
            <div class="form-group m-form__group row {{ $errors->has('privacy_policy') ? 'has-danger' : ''}}">
                ...
                <div class="col-9">
                    <textarea class="form-control m-input" placeholder="{{ __('admin.privacy_policy') }}" name="privacy_policy" ></textarea>
            ...
            <div class="form-group m-form__group row {{ $errors->has('privacy_policy_ar') ?'has-danger' : ''}}">
                ...
                <div class="col-9">
                    <textarea class="form-control m-input" placeholder="{{ __('admin.privacy_policy_ar') }}" name="privacy_policy_ar" ></textarea>
            ...
            <div class="form-group m-form__group row {{ $errors->has('influncer_privacy_title') ? 'has-danger' : ''}}">
                ...
                <div class="col-9">
                    <textarea class="form-control m-input" placeholder="{{ __('admin.influncer_privacy_title') }}" name="influncer_privacy_title" ></textarea>
            ...
            <div class="form-group m-form__group row {{ $errors->has('influncer_privacy_policy') ? 'has-danger' : ''}}">
                ...
                <div class="col-9">
                    <textarea class="form-control m-input" placeholder="{{ __('admin.influncer_privacy_policy') }}" name="influncer_privacy_policy" ></textarea>
            ...
            <div class="form-group m-form__group row {{ $errors->has('influncer_privacy_title_ar') ? 'has-danger' : ''}}">
                ...
                <div class="col-9">
                    <textarea class="form-control m-input" placeholder="{{ __('admin.influncer_privacy_title_ar') }}" name="influncer_privacy_title_ar" ></textarea>
            ...
            <div class="form-group m-form__group row {{ $errors->has('influncer_privacy_policy_ar') ? 'has-danger' : ''}}">
                ...
                <div class="col-9">
                    <textarea class="form-control m-input" placeholder="{{ __('admin.influncer_privacy_policy_ar') }}" name="influncer_privacy_policy_ar" ></textarea>
