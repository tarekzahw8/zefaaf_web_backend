@extends('admin.layouts.index_layout' , ['title' => __('admin.roles') ,'route' => 'roles'])

@section('content')

<div class="row" style="display:none">
    <form class="m-form" action="{{url('admin/lawDegree/search')}}" method="get" id="search_form">
            ...
            <div class="m-portlet__head">
                ...
                <div class="m-portlet__head-wrapper">
                    ...
                    <div class="m-portlet__head-tools">
                        ...
                        <a href="{{url('admin/roles/create')}}" class="btn btn-brand m-btn m-btn--icon m-btn--wide m-btn--md m--margin-right-10">
                            <span>
...
<div>
    <a href="{{url('admin/roles')}}" class="btn btn-danger m-btn m-btn--icon m-btn--wide">
        <span>
