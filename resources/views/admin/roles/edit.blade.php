...
<div class="m-portlet">
    ...
    <!--begin::Form-->
    <form class="m-form" action="{{url('admin/roles')}}/{{ $row->id }}" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group m-form__group row {{ $errors->has('name') ? 'has-danger' : ''}}">
                    ...
                    <div class="col-9">
                        <input type="text" name="name" class="form-control m-input"
                                placeholder="الصلاحية" value="{{ $row->name }}">
			    ...
			    <label for="name" class="col-1 col-form-label"> الاقسام   </label>
				    <div class="m-checkbox-inline">
                         ...
                         <label class="m-checkbox">
                            ...
                            {{ (in_array($module->id, $role_modules))? "checked": "" }}>  {{ $module->name_ar }}
                            <span></span>
                        </label>
                        @endforeach
