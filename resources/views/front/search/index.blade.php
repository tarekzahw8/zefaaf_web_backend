...
@section('content')
            ...
            <a href="{{ url('/automated-search/filter') }}" class="btn btn-link write-msg main-btn" style="float: right;margin-right: 45px;">
                ...
                <div class="tab-content" id="nav-tabContent">
                  <div class="tab-pane fade show active"  id="all" role="tabpanel" aria-labelledby="all-tab">
                    <div class="row subscribers-list members-search-result" data-page="1">
                      ...
                      <div class="col-md-12">
                        @if(!$settingsExist)
                        قم بإدخال إعدادات البحث الآلي لكي تظهر هنا نتائج البحث
                        @else
                        <div class="col-md-10">
  ...
  $("#loadMore").on('click', function (e) {
      ...
      $.ajax({
        ...
        success: function(response){
            ...
            //$(".members-search-result").append(response);
            page = page+1;
